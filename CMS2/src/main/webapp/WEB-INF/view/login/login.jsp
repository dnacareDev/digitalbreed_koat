...
<head>
    ...
    <link rel="stylesheet" href="/digit/css/login/login.css">
                    ...
                    <div class="container_cover clearfix">
                        ...
                        <div class="contents">
                            ...
                            <div class="form_list clearfix">
                            	<form action="/digit/loginForm" method="POST">
                                <div class="box_input">
                                    <div class="id">
                                ...
                                <div class="link_list clearfix">
                                    <a href="" class="member" onclick="popupShow('#member1')">이용신청</a>
                                    <a href="" class="psSch" onclick="popupShow('#member2')">비밀번호초기화</a>
                                    <a href="" class="psSch" onclick="popupShow('#member3')" style="margin-right: 10px;">비밀번호변경</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="member_content">
                        ...
                        <div class="member_email">
                            ...
                            <div class="email">
                                ...
                                <input type="password" id="new_password" name="" autocomplete="off">
                            </div>
                            <div class="email">
                                <span class="sub_title">비밀번호 재입력</span>
                                <input type="password" id="chk_password" name="" autocomplete="off">
                            </div>
                        ...
                        <div class="member_submit">
                            ...
                            <button type="button" onclick="Join();">정보신청 메일 신청</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="member_content">
                        ...
                        <div class="member_email">
                            ...
                            <div class="email" id="temp_password" style="display: none;">
                                <!-- <span class="sub_title">비밀번호가 초기화 되었습니다.<br>담당자에게 연락 바랍니다. 063-219-8852</span> -->
								 <span class="sub_title">비밀번호가 초기화 되었습니다.<br>이메일을 확인 해 주시기 바랍니다.</span>
                                <!-- <input type="text" id="change_password" name="" readonly="readonly"> -->
                            </div>
                        </div>
                        <div class="member_submit">
                            <button type="button" id="findBtn" onclick="FindPassword()">비밀번호 초기화</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="member_pop_cover clearfix">
                    ...
                    <div class="member_content">
                        ...
                        <div class="member_email">
							...
							<div class="email">
                                <span class="sub_title">현재 비밀번호</span>
                                <input type="password" id="mem2_password" name="" autocomplete="off">
                            </div>
                            <div class="email">
                                <span class="sub_title">변경 비밀번호</span>
                                <input type="password" id="mem3_password" name="" autocomplete="off">
                            </div>
                            <div class="email">
                                <span class="sub_title">변경 비밀번호 재입력</span>
                                <input type="password" id="mem3_chk_password" name="" autocomplete="off">
                            </div>
                        </div>
...
<script type="text/javascript">
			...
			$.ajax(
			{
				...
				success : function(result)
				{
					...
					else
					{
						...
						$("#change_password").val("담당자에게 연락 바랍니다. 063-219-8852");
	...
	function UpdatePassword()
	{
		...
		var old_password = $("#mem2_password").val();
		var user_password = $("#mem3_password").val();
		var chk_password = $("#mem3_chk_password").val();
		
		var regEmail = /([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/;
		
		if(regEmail.test(user_username) || user_username =="admin")
		{
			$("#mem3_username_error").css("display", "none");
	
			if(old_password == "")
			{
				$("#mem3_password_error").text("현재 비밀번호를 입력해주세요.");
			...
			else
			{
				if(user_password == chk_password)
				{
					...
					$.ajax(
					{
						url : "oldcheckUsername",
						method : "POST",
						data : {"user_username" : user_username, "old_password" : old_password},
						dataType : "JSON",
						success : function(result)
						{
							if(result == 0)
							{
								$("#mem3_password_error").text("계정 정보가 일치하지 않습니다.");
								$("#mem3_error").css("display", "block");
							}
							else
							{
								...
								$.ajax(
								{
									...
									success : function(result)
									{
										...
										if(result == 0)
										{
											$("#mem3_password_error").text("비밀번호변경에 실패하였습니다.");
											$("#mem3_error").css("display", "block");
										}
										else
										{
