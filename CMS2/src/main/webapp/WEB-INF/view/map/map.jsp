        ...
        <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
            <%@ page import="java.util.*" %>
                ...
                <body>
                    <div id="wrap">
                        <div
                            style="position:fixed; left:50px; bottom:150px; display:none; z-index:9999999999999999999999;">
                            <div>gff</div>
                        ...
                        <header id="header">
                            ...
                            <nav id="nav">
                                <ul class="out_list_wrap">
                                    ...
                                    <li class="inner_list">
                                        <a class="list_link" href="/digit/karyotype_list" style="text-indent: 1em;">염색체
                                            시각화</a>
                                    </li>
                                    <li class="inner_list">
                                    ...
                                    <li class="inner_list">
                                        <a class="list_link" href="/digit/polymorphic" style="text-indent: 1em;">다형성
                                            분자표지</a>
                                    </li>
                                    <li class="inner_list">
                                        <a class="list_link" href="/digit/mabc_list" style="text-indent: 1em;">MABC
                                            분석</a>
                                    </li>
                                    <li class="inner_list">
                                        <a class="list_link" href="/digit/phylogeny" style="text-indent: 1em;">유사도
                                            분석</a>
                                    </li>
                                    <li class="inner_list">
                                        <a class="list_link" href="/digit/specificmaker" style="text-indent: 1em;">계통구분용
                                            분자표지</a>
                                    </li>
                                    <c:if test="${user.user_type == 0}">
                                        <li class="inner_list">
                                        ...
                                        <li class="inner_list">
                                            <a class="list_link" href="/digit/ngs_list" style="text-indent: 1em;">NGS
                                                MABC</a>
                                        </li>
                                        <li class="inner_list">
                                            <a class="list_link" href="/digit/snp_list" style="text-indent: 1em;">SNP
                                                분석</a>
                                        </li>
                                    </c:if>
                                </ul>
                                ...
                                <c:if test="${user.user_type == 0}">
                                    <li class="out_list">
                                        ...
                                        <ul class="inner_list_wrap">
                                            <li class="inner_list">
                                                <a class="list_link" href="/digit/marker_list"
                                                    style="text-indent: 1em;">유전체 및 분자표지 데이터 베이스 관리</a>
                                            </li>
                                            <li class="inner_list">
                                                <a class="list_link" href="/digit/result_list"
                                                    style="text-indent: 1em;">결과 데이터 관리</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="out_list">
                                            ...
                                            <ul class="alram_list_box">
                                                ...
                                                <c:forEach var="n" items="${notice}">
                                                    <li class="alram_list">
                                                        <!-- 리스트 클릭시 페이지 이동 -->
                                                        <c:choose>
                                                            <c:when test="${n.outcome_type eq 1}"><a class="alram_link"
                                                                    href="/digit/map"></c:when>
                                                            <c:when test="${n.outcome_type eq 2}"><a class="alram_link"
                                                                    href="/digit/polymorphic"></c:when>
                                                            <c:when test="${n.outcome_type eq 3}"><a class="alram_link"
                                                                    href="/digit/mabc_list"></c:when>
                                                            <c:when test="${n.outcome_type eq 4}"><a class="alram_link"
                                                                    href="/digit/phylogeny"></c:when>
                                                            <c:when test="${n.outcome_type eq 5}"><a class="alram_link"
                                                                    href="/digit/specificmaker"></c:when>
                                                            <c:when test="${n.outcome_type eq 6}"><a class="alram_link"
                                                                    href="/digit/qtl"></c:when>
                                                            <c:when test="${n.outcome_type eq 7}"><a class="alram_link"
                                                                    href="/digit/ngs_list"></c:when>
                                                            <c:when test="${n.outcome_type eq 8}"><a class="alram_link"
                                                                    href="/digit/snp_list"></c:when>
                                                        </c:choose>
                                                        <span class="alram_date">
                                                            <c:out value="${n.create_date}" />
                                                        </span>
                                                        ...
                                                        <p class="alram_Ad alram_text">분석 구분:
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${n.outcome_type eq 5}">계통구분용 분자표지
                                                                </c:when>
                                                        ...
                                                        <p class="alram_Ad alram_text">전달 사항:
                                                            <span class="alram_chief">
                                                                <c:out value="${n.outcome_comment}" />
                                                            </span>
                                                        </p>
                                                        </a>
                                                    </li>
                            ...
                            <div class="sect_warp">
                                <section class="mark_map_sect">
                                    <div class="data_table_title_wrap">
                                        ...
                                        <!-- 클라스 추가 -->
                                        <a class="result_down_btn" download
                                            href="<c:out value='${outcome.outcome_file}'/>"
                                            onclick="<c:out value='DownloadBtn(${outcome.outcome_id});'/>">결과파일다운</a>
                                    </div>
                                    <div class="mab_top_bar">
                                            ...
                                            <div class="select_box">
                                                <div class="select_wrap">
                                                    ...
                                                    <select id="" class="type_select" disabled>
                                                        <option value="">
                                                            <c:out value="${marker[0].marker_crop}" />
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="select_wrap">
                                                    ...
                                                    <select id="" class="type_select_info" disabled>
                                                        <option value="">
                                                            <c:out value="${marker[0].marker_version}" />
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mab_bar_right mab_bar">
                                            <div class="input_file_wrap">
                                                <div class="under_marker_check">
                                                    <input type="checkbox" checked data-toggletype="admin"
                                                        onchange="onChangeToggle(this)" id="toggleAdmin">
                                                    <span>분자표지 세트</span>
                                                    <input type="checkbox" data-toggletype="user"
                                                        onchange="onChangeToggle(this)" id="toggleUser">
                                                ...
                                                <form action="" id="insertForm" method="POST"
                                                    ...
                                                    <input id="input-file" type="file" class="addMabcFile"
                                                        onchange="readUserExcel()" name="file">
                                                </form>
                                        ...
                                        <p class="give_info de_give_info">
                                            <c:out value="${marker[0].marker_credit}" />
                                        </p>
                                    </div>
                                </section>
                                ...
                                <div class="visualWrap">
                                        ...
                                        <div class="table_header data_header">
                                            <div class='download_btn_wrap'>
                                                ...
                                                <div style="margin-right: auto; margin-left:10px;"
                                                    class="commonBtn download" onclick="onClickDownload()">내려받기</div>
                                            </div>
                                        </div>
                                        <div class="tableWrap">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>
                                                            <input type="checkbox" onchange="onChangeAllCkBox(this)"
                                                                id="allCkBox">
                                    ...
                                    <div class="chartArea">
                                        <div class="cart_header data_header">
                                            ...
                                            <input type="text" onchange="onChangeGff(this)" class="chartInput"
                                ...
                                <div class="modalVisual">
                                    ...
                                    <div class="modalChartContainer" id="_modalChartContainer">
                                        <div class="modalChartCtl">
                                            ...
                                            <input onchange="onChangeModalSlider(this)" type="range" min="1" max="8"
                                                value="3" class="modalSlider">
                                        </div>
                                        ...
                                        <div class="modalTable" id="_modalTable">
                                            ...
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th>
                                                            <input class="modalAllInput"
                                                                onchange="onChangeModalAllCkBox(this)" type="checkbox"
                                                                id="AllInput">
                                                        </th>
                                                        <th>
                                                            <div>
