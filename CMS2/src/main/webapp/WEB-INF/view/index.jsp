				...
				<ul class="out_list_wrap">
                    ...
                    <c:if test="${user.user_type == 0}">
	                    <li class="out_list">
	                        ...
	                        <ul class="inner_list_wrap">
	                            <li class="inner_list">
	                                <a class="list_link" href="digit/marker_list">유전체 및 마커정보 데이터 베이스 관리</a>
	                            </li>
	                            <li class="inner_list">
	                                <a class="list_link" href="digit/result_list">결과 데이터 관리</a>
	                            </li>
	                        </ul>
	                    </li>
                    </c:if>
					<li class="out_list">
						<a href="/digit/Register_result_data.html">
