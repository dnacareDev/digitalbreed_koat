...
public class SnpController
{
	...
	@ResponseBody
	@RequestMapping("searchSnpRawFiles")
	public LinkedList<String> searchSnpRawFiles(@RequestParam("jobid") String jobid) {
		
		//System.out.println("jobid : " + jobid);
		
		LinkedList<String> list = new LinkedList<>();
		
		String path = "/data/apache-tomcat-9.0.8/webapps/ROOT/common/web/snpanalysis/resultfiles/" + jobid;
		...
		for(int i=0 ; i<files.length ; i++) {
			...
			if(file.isFile() && (extension.equals("fastq") || extension.equals("fasta") ) ) {
				list.push(fileName);
			}
		}
