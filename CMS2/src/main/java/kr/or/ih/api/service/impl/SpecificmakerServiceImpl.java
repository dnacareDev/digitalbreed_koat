...
import kr.or.ih.api.service.mapper.SpecificmakerMapper;

@Service
public class SpecificmakerServiceImpl implements SpecificmakerService
{
	@Autowired
	private SpecificmakerMapper mapper;
