...
public class RunUpgma {
          
	 public  void MakeRunUpgma(String jobid, String filename) {
		...
		String result_path = r_path+"upgma/"+jobid+"/";

		String cmd = "Rscript " + r_path+"final_upgma.R "  + " " + jobid + " " + input_file;
