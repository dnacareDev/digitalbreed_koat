        ...
        <main id="main">
            ...
            <section class="data_table_section">
                ...
                <div class="mab_top_bar">
                    	...
                    	<form action="InsertSpecific" id="insertForm" method="POST" enctype="multipart/form-data">
	                        <div class="input_file_wrap">
	                            <div class="data_sample_down">
	                                ...
	                                <input id="input-file1" type="file" class="addMabcFile" name="main_file">
	                            </div>
	                            ...
	                            <div class="data_sample_down">
	                                ...
	                                <input type="text" class="file_text" placeholder="" readonly disabled>
	                                <input id="input-file2" type="file" class="addMabcFile" name="option_file">
	                            </div>
                    ...
                    <div class="view"> 
                     	<button type="button" class="runBtn" onclick="InsertBtn();">계통구분용 마커 분석실행</button>
                    </div>
                </div>
...
<script type="text/javascript">
	...
	function SaveBtn()
	{
		...
		{
			var data = {"user_username" : user_username, "outcome_file" : outcome_file, "outcome_type" : 5};
