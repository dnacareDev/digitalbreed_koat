...
<script type="text/javascript">
	...
	function Grid()
	{
		var header = [
			...
			{'header' : '마커 맵', 'name' : 'map', 'sortable' : true, 'filter' : {type: 'text', showApplyBtn: true, showClearBtn: true}},
			{'header' : '다형성 마커', 'name' : 'poly', 'sortable' : true, 'filter' : {type: 'text', showApplyBtn: true, showClearBtn: true}},
			{'header' : 'MABC 분석', 'name' : 'mabc', 'sortable' : true, 'filter' : {type: 'text', showApplyBtn: true, showClearBtn: true}},
			{'header' : '유사도 분석', 'name' : 'phylogeny', 'sortable' : true, 'filter' : {type: 'text', showApplyBtn: true, showClearBtn: true}},
			{'header' : '계통구분용 마커', 'name' : 'spec', 'sortable' : true, 'filter' : {type: 'text', showApplyBtn: true, showClearBtn: true}},
			{'header' : 'QTL 분석', 'name' : 'qtl', 'sortable' : true, 'filter' : {type: 'text', showApplyBtn: true, showClearBtn: true}},
			{'header' : 'NGS MABC', 'name' : 'ngs', 'sortable' : true, 'filter' : {type: 'text', showApplyBtn: true, showClearBtn: true}},
			{'header' : 'SNP 분석', 'name' : 'snp', 'sortable' : true, 'filter' : {type: 'text', showApplyBtn: true, showClearBtn: true}}
		]
