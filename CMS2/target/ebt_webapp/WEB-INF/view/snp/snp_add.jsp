...
<body>
                ...
                <div class="mab_top_bar">
                    <div class="mab_bar_left mab_bar">
                        <div class="select_box add_select_box">
                           ...
                           <div class="commonBtn" id="snpSaveBtn" onclick="SaveBtn()" style="display: none;">분석 저장</div>
                        </div>
                    </div>
                    	...
                    	<form action="InsertSNP" id="insertForm" method="POST" enctype="multipart/form-data">
	                        <div class="add_file_box">
	                            <div class="select_wrap input_mab_wrap">
	                                ...
	                                <input type="text" placeholder="상품명을 입력해주세요" name="sample_name">
	                            </div>
	                            <div class="input_file_wrap">
	                                <div class="input_wrap">
	                                    <input type="text" class="file_text" readonly disabled >
	                                    <input id="input-file1" type="file" class="addMabcFile file1" name="first_file">
	                                </div>
	                            ...
	                            <div class="input_file_wrap">
	                                <div class="input_wrap">
	                                    <input type="text" class="file_text" readonly disabled >
	                                    <input id="input-file2" type="file" class="addMabcFile file2" name="second_file">
	                                </div>
	                                <div class="flie_btn_box">
	...
	<script>
		...
		function SaveBtn()
		{
			...
			{
				var data = {"user_username" : user_username, "outcome_file" : outcome_file, "outcome_type" : 8, "marker_id" : marker_id};
